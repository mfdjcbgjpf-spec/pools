...
const PAYOUT_REFERENCE = {
  empirical: [
    ...
    { tail: "USL (ticket 277838, ~15+ safe legs on board — diluted)", tier: "7/8", payoutRs: 123.02 },
    { tail: "Coupon A, 15 Jul 2026 (only 2 safe legs on the full 35-board — scarce)", tier: "7/8", payoutRs: 912.00,
      note: "Same 7/8 tier as the USL line above paid 7.4x more — coupon-wide safe-leg scarcity, not the specific legs you hold, drives reward. Ticket itself graded 4/8 (lost) — this is the dividend schedule, not a personal win." },
    { tail: "Coupon A, 15 Jul 2026 (same coupon, 8/8 tier)", tier: "8/8", payoutRs: 82024.00,
      note: "74x the diluted-coupon 8/8 payout (Rs 1,101.74) at identical stake — confirms scarce coupons are worth targeting even though they're harder to land." },
  ],
  dilutionCurve: [
    ...
    { safeLegsOn35: "≤ 2 (extreme)", read: "Confirmed empirically 15 Jul 2026: 7/8 paid Rs 912 (7.4x the diluted rate) and the 8/8 pool sat at Rs 82,024 (74x). But reaching 7-8/8 gets harder too — check the away-scoring-rate filter still clears enough legs before assuming a scarce board is automatically playable.", staking: "Only if legs still clear the discipline gate on their own merits — scarcity alone isn't a reason to lower your bar." },
  ],
  historicDividendRanges: {
    goalRush8of8: "Rs 600 – 82,024",
    goalRush7of8: "Rs 120 – 912",
